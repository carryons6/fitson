...
_TRANSLATIONS: dict[str, dict[str, str]] = {
    "zh_CN": {
        ...
        "Right-drag ROI Task": "右键拖拽 ROI 任务",
        "Measure ROI": "测量 ROI",
        "Extract Sources in ROI": "提取 ROI 内源",
        "ROI: Measure": "ROI：测量",
        "ROI: Extract Sources": "ROI：提取源",
        "Right-drag measures pixel statistics for one ROI.": "右键拖拽一个 ROI 以测量像素统计。",
        "Right-drag runs SEP source extraction for one ROI.": "右键拖拽一个 ROI 以运行 SEP 源提取。",
        "ROI task: Measure. Right-drag an area on the image.": "ROI 任务：测量。请在图像上右键拖拽一个区域。",
        "ROI task: Extract Sources. Right-drag an area on the image.": "ROI 任务：提取源。请在图像上右键拖拽一个区域。",
        "Measurement & Photometry": "测量与测光",
        "WCS & Gaia": "WCS 与 Gaia",
        "Compare Frames": "比较帧",
        "Markers": "标记",
        ...
        "FITS load cancelled.": "FITS 加载已取消。",
        "Cancelling SEP extraction...": "正在取消 SEP 提取...",
        "Waiting for background tasks to stop...": "正在等待后台任务停止...",
        "Background calculation failed": "背景计算失败",
        "Background unavailable: {detail}": "背景不可用：{detail}",
        "Error": "错误",
        "Append failed": "追加失败",
        "Open failed": "打开失败",
        ...
        "No Image Loaded": "未加载图像",
        "Double-click, drop FITS files here, or press Ctrl+O to open.": "双击画布、将 FITS 文件拖到这里，或按 Ctrl+O 打开。",
        ...
        "Composite layout does not support direct ROI selection. Switch back to Single Frame View first.": "复合布局下无法直接框选 ROI。请先切回单帧显示。",
        "Wait for moving-target detection to finish before selecting a ROI.": "请等待动目标检测结束后再选择 ROI。",
        ...
        "Zoom: {percent}% (1:1)": "缩放：{percent}% (1:1)",
        "Pixel: ({x}, {y})": "像素：({x}, {y})",
        "Value: {value}": "值：{value}",
        ...
        "Measurement Workbench": "测量工作台",
        "ROI Pixel Statistics": "ROI 像素统计",
        "Region:": "区域：",
        "Pixels:": "像素数：",
        "Finite / Invalid:": "有限值 / 无效值：",
        ...
        "Center X:": "中心 X：",
        "Center Y:": "中心 Y：",
        "Aperture radius:": "孔径半径：",
        "Background inner radius:": "背景内半径：",
        "Background outer radius:": "背景外半径：",
        "Measure Aperture": "测量孔径",
        "Clear Results": "清除结果",
        "Photometry and Shape": "测光与形态",
        "Net flux:": "净流量：",
        "Aperture sum:": "孔径总和：",
        "Background / pixel:": "每像素背景：",
        "Background RMS:": "背景 RMS：",
        "Flux uncertainty:": "流量不确定度：",
        "SNR:": "信噪比：",
        "Centroid (x, y):": "质心 (x, y)：",
        "FWHM:": "FWHM：",
        "Peak above background:": "背景以上峰值：",
        "Aperture / Background pixels:": "孔径 / 背景像素：",
        "Load an image to begin measuring.": "请加载图像后开始测量。",
        "Ready — image {width} × {height} pixels.": "就绪 — 图像为 {width} × {height} 像素。",
        "ROI statistics updated.": "ROI 统计已更新。",
        "ROI contains no finite pixels.": "ROI 中没有有限像素值。",
        "Aperture measurement updated.": "孔径测量已更新。",
        "Measuring...": "正在测量...",
        "Measurement failed: {detail}": "测量失败：{detail}",
        "Measurement results cleared.": "测量结果已清除。",
        "ROI measurement failed: {detail}": "ROI 测量失败：{detail}",
        "Aperture parameters changed; measure again.": "孔径参数已更改，请重新测量。",
        "Image Comparison": "图像比较",
        "Images": "图像",
        "Not selected": "未选择",
        "Choose frame A...": "选择帧 A...",
        "Choose frame B...": "选择帧 B...",
        "Frame A:": "帧 A：",
        "Frame B:": "帧 B：",
        "Comparison": "比较",
        "Side by side": "并排",
        ...
        "Automatic": "自动",
        "Direct pixels": "直接像素",
        "WCS (nearest neighbour)": "WCS（最近邻）",
        "Alignment:": "对齐：",
        "Synchronize zoom and pan": "同步缩放和平移",
        "Blink controls": "闪烁控制",
        " ms": " 毫秒",
        "Start blinking": "开始闪烁",
        "Stop blinking": "停止闪烁",
        "Compare": "比较",
        "Swap": "交换",
        "Choose two images to compare.": "请选择两幅要比较的图像。",
        "Ready to compare.": "已准备好进行比较。",
        "Comparison ready.": "比较结果已就绪。",
        "Comparison failed.": "比较失败。",
        "Unavailable frame": "帧不可用",
        "Frame {index}": "帧 {index}",
        "Load at least two frames to compare.": "请至少加载两帧以进行比较。",
        "Choose Comparison Frame": "选择比较帧",
        "Left frame:": "左侧帧：",
        "Right frame:": "右侧帧：",
        "Choose two valid frames to compare.": "请选择两个有效帧进行比较。",
        "Wait for the current task to finish before comparing.": "请等待当前任务完成后再进行比较。",
        "Preparing comparison...": "正在准备比较...",
        "Preparing image comparison...": "正在准备图像比较...",
        "Comparison renderer produced no display image.": "比较渲染器未生成可显示图像。",
        "Image comparison failed": "图像比较失败",
        "Image comparison cancelled.": "图像比较已取消。",
        "Cancelling image comparison...": "正在取消图像比较...",
        "Exit image comparison before selecting a ROI.": "请先退出图像比较，再选择 ROI。",
        "WCS & Catalog": "WCS 与星表",
        "Sky Coordinates": "天球坐标",
        "No celestial WCS in the current frame.": "当前帧没有可用的天球 WCS。",
        "Show RA/Dec grid": "显示 RA/Dec 网格",
        "Gaia DR3 Cone Search": "Gaia DR3 锥形检索",
        "Maximum sources:": "最大源数：",
        "Faint G limit:": "G 星等暗端上限：",
        "Query Gaia": "查询 Gaia",
        "Load a WCS-enabled FITS image to query Gaia.": "请加载带 WCS 的 FITS 图像以查询 Gaia。",
        "Source ID": "源 ID",
        "RA": "赤经",
        "Dec": "赤纬",
        "G mag": "G 星等",
        "Center: RA {ra:.6f}°, Dec {dec:.6f}°": "中心：赤经 {ra:.6f}°，赤纬 {dec:.6f}°",
        "Ready to query Gaia DR3.": "已准备好查询 Gaia DR3。",
        "Querying Gaia DR3...": "正在查询 Gaia DR3...",
        "Showing {count} Gaia source(s).": "正在显示 {count} 个 Gaia 源。",
        "Gaia query failed: {detail}": "Gaia 查询失败：{detail}",
        "No celestial WCS is available.": "没有可用的天球 WCS。",
        "Wait for the current task to finish before querying Gaia.": "请等待当前任务完成后再查询 Gaia。",
        "Showing {count} Gaia source(s) inside the image.": "图像范围内正在显示 {count} 个 Gaia 源。",
        "Gaia query failed": "Gaia 查询失败",
        "Gaia query cancelled.": "Gaia 查询已取消。",
        "Cancelling Gaia query...": "正在取消 Gaia 查询...",
        "DS9 Regions": "DS9 区域",
        "No regions loaded.": "尚未加载区域。",
        "Show region overlay": "显示区域覆盖层",
        "System": "坐标系",
        "Shape": "形状",
        "Mode": "模式",
        "Label": "标签",
        "Color": "颜色",
        "Add Current ROI": "添加当前 ROI",
        "Add Current Aperture": "添加当前孔径",
        "Import...": "导入...",
        "Export...": "导出...",
        "Ready to import a DS9 Region file.": "已准备好导入 DS9 Region 文件。",
        "Imported {count} region(s); skipped or warned about {warnings} record(s).": "已导入 {count} 个区域；跳过或警告 {warnings} 条记录。",
        "Imported {count} region(s).": "已导入 {count} 个区域。",
        "Exported {count} region(s).": "已导出 {count} 个区域。",
        "Regions cleared.": "区域已清除。",
        "Include": "包含",
        "Exclude": "排除",
        "{count} region(s); showing the first {shown}.": "已加载 {count} 个区域；显示前 {shown} 个。",
        "{count} region(s) loaded.": "已加载 {count} 个区域。",
        "Import DS9 Regions": "导入 DS9 区域",
        "Export DS9 Regions": "导出 DS9 区域",
        "DS9 Region Files (*.reg);;All Files (*)": "DS9 Region 文件 (*.reg);;所有文件 (*)",
        "Region import failed: {detail}": "区域导入失败：{detail}",
        "Region export failed: {detail}": "区域导出失败：{detail}",
        "Skipped {count} sky region(s): the current frame has no WCS.": "已跳过 {count} 个天球区域：当前帧没有 WCS。",
        "Rendered regions with {count} unsupported or off-image item(s) skipped.": "区域已渲染；跳过 {count} 个不支持或位于图像外的项目。",
        "Physical regions are displayed using image-pixel coordinates.": "Physical 区域按图像像素坐标显示。",
        "Current ROI added to DS9 regions.": "当前 ROI 已添加到 DS9 区域。",
        "Current aperture added to DS9 regions.": "当前孔径已添加到 DS9 区域。",
        "Region import failed": "区域导入失败",
        "Region export failed": "区域导出失败",
